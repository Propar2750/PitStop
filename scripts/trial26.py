...
np.save('/tmp/trial26_oof_xgb.npy', oof_xgb)
np.save('/tmp/trial26_oof_cb.npy',  oof_cb)
np.save('/tmp/trial26_test_xgb.npy', test_xgb_new)
np.save('/tmp/trial26_test_cb.npy',  test_cb_new)
