"""Trial 48: TabNet (pytorch-tabnet) for in-family architectural diversity.
...
Saves:
  * /tmp/trial48_oof.npy, /tmp/trial48_test.npy
...
np.save("/tmp/trial48_oof.npy", oof)
np.save("/tmp/trial48_test.npy", test_pred)
...
sub.to_csv(DATA_DIR / "submission_trial48.csv", index=False)
print(f"Wrote submission_trial48.csv (7-way LR-meta incl TabNet)")
